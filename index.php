...
<form action="/linkerregions/query.php">
  <p>Query by Gene Tree ID:</p>
  <input type="text" name="id">
  <input type="submit" value="Submit">
</form>

<form action="/linkerregions/pfam.php">
  <p>Query by PFAM ID:</p>
  <input type="text" name="id">
  <input type="submit" value="Submit">
</form>


<form action="/linkerregions/linker.php">
  <p>Query by Linker ID:</p>
  <input type="text" name="id">
  <input type="submit" value="Submit">
</form>


<form action="/linkerregions/domain.php">
  <p>Query by Domain ID:</p>
  <input type="text" name="id">
  <input type="submit" value="Submit">
</form>
